...
var tree_data = {
	...
	'Snackes' : {name: 'Snackes', type: 'item'}	,
	'Services' : {name: 'Services', type: 'item'}	,
	'Home appliance' : {name: 'Home appliance', type: 'item'}
}
...
tree_data['Clothing']['additionalParameters'] = {
	'children' : {
		'Men' : {name: 'Men', type: 'folder'},
		'Women' : {name: 'Women', type: 'folder'},
		
	}
}
tree_data['Clothing']['additionalParameters']['children']['Men']['additionalParameters'] = {
	'children' : {
		'coat' : {name: 'coat', type: 'item'},
		'T-shirt' : {name: 'T-shirt', type: 'item'},
		'sweater' : {name: 'sweater', type: 'item'},
		'pants' : {name: 'pants', type: 'item'},
		
	}
}
tree_data['Clothing']['additionalParameters']['children']['Women']['additionalParameters'] = {
		'children' : {
			'dress' : {name: 'dress', type: 'item'},
			'trousers' : {name: 'trousers', type: 'item'},
			'T-shirt' : {name: 'T-shirt', type: 'item'},
			'suit' : {name: 'suit', type: 'item'},
