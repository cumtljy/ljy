...
<html >
  ...
  <form action="tell" method="post">
    <c:forEach items="${requestScope.user_list }" var="w">    

       <div class="row">
       	        <div class="form-group">
				<label for="username" class="col-sm-4 control-label">用户名</label>
				<div class="col-sm-8">
				<input type="text" class="form-control" id="username" name="username" value="${w.username }">
				</div>				
		</div>
				...
				<div class="col-sm-8">
				<input type="text" class="form-control" id="email" name="email" value="${w.email }">
				</div>				
		</div>	
				
				
				<div class="col-sm-8 col-sm-offset-4"><button type="submit" class="btn btn-primary">邮件通知</button></div>
       </div>
       </c:forEach>
</form>
								<!-- PAGE CONTENT ENDS -->
