     	...
     	<thead>
            ...
            <c:forEach items="${requestScope.order_list }" var="order">
             <tr >
             	...
             	<td style="vertical-align: middle;"><a href="detail.action?id=${order.id }">订单明细</a> </td>
             	<td style="vertical-align: middle;"><a href="commentorder.action?id=${order.id }">评价订单</a></td>
             </tr>
            </c:forEach>
     </table>
 </div>
