...
<div class="content inside-page login">
        <h2 class="title">Login/AdminLogin</h2>
        		<div class="breadcrumb"><a href="index">Home</a> / 管理员登录 </div>
            ...
            <div class="row">
                <div class="col-sm-3 sitemap">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li><a href="collect">查看收藏</a></li>
                        <li><a href="checkout">查看购物车</a></li>
                        <li><a href="payment">查看订单</a></li>                      
                    </ul>
                </div>              
