  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
      ...
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown">
          <a href="checkout" class="dropdown-toggle cart" data-toggle="dropdown"><span class="glyphicon glyphicon-shopping-cart"></span> Cart  <span class="caret"></span></a>
...
<div class="content inside-page about">
       ...
       <h2 class="title"></h2>
       <div class="breadcrumb"><a href="index">Home</a> / Back Password</div>
<form action="update" method="post">
       <div class="row">
       	<div class="form-group">
				<label for="inputEmail3" class="col-sm-4 control-label">Password</label>
				<div class="col-sm-8">
				<input type="text" class="form-control" id="password" name="password" value="${sessionScope.user1.password }">
				</div>				
				</div>
  <a href="login" class="btn btn-primary pull-left">立即登录</a>
		<a href="updatePassword" class="btn btn-primary pull-right">修改密码</a>
       </div>
