...
<div class="content inside-page collection">
       ...
       <h2 class="title">男装</h2>

        <div class="breadcrumb"><a href="index">Home</a> / Men</div>
<form action="Men" method="post">
       
       <div class="row">
        <c:forEach items="${requestScope.men_list }" var="g">
            <div class="col-sm-2 col-xs-6">
                <div class="product">
                            <a href="product.action?id=${g.id }"><img src="images/photos/${g.image}" class="img-responsive"></a>
                            <div class="row title-price">
                                <div class="col-md-8"><h5><a href="product.action?id=${g.id }">${g.good_name }</a></h5></div>
