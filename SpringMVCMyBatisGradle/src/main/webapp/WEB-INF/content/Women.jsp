...
<div class="content inside-page collection">
       ...
       <h2 class="title">女装</h2>

        <div class="breadcrumb"><a href="index">Home</a> / Women</div>
<form action="Women" method="post">
       
       <div class="row">
        <c:forEach items="${requestScope.women_list }" var="w">
            <div class="col-sm-2 col-xs-6">
                <div class="product">
                            <a href="product.action?id=${w.id }"><img src="images/photos/${w.image}" class="img-responsive"></a>
                            <div class="row title-price">
                                <div class="col-md-8"><h5><a href="product">${w.good_name }</a></h5></div>
                                <div class="col-md-4"><span>${w.price }</span></div>
                            </div>
                            <a href="product.action?id=${w.id }" class="btn btn-default"><i class="fa fa-shopping-cart"></i> 查看详情</a>
                </div>
            </div>
             </c:forEach>   
        </div>
